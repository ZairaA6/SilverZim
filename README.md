# SilverZim
 ...
 SilverZim - F1 Educational Game w/ AI opponents
...
One being that though I had two main python files, it is definitely bad practice to keep a lot of code within one main file for future maintainability reasons. Though I was able to collapse functions within vscode, this may impact readability for others and maintenance in the future. Also, it would've been useful to use version control from the very start.
...
```bash
git clone https://github.com/ZairaA6/SilverZim
```
...
In terminal, it will ask for a username. Then, hit enter & return to the pygame window. Game begins.
